            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Création d'une nouvelle visite</h4>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                {!! Form::open(array('route' => 'visits.store','method'=>'POST')) !!}
                                ...
                                <div class="row">
                                    <div class="offset-md-3 col-md-6 offset-md-3"> 
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                {!! Form::text('city', null, array('placeholder' => 'Désignation du site visitée ','class' => 'form-control')) !!}
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-12 col-form-label">Coordonées géographique</label>
                                            <div class="col-sm-12">
                                                {!! Form::text('coordonate', null, array('placeholder' => 'Coordonnée géographique du site visitée ','class' => 'form-control')) !!}
                                            </div>
                                        </div>


                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-12 col-form-label">Date de la visite</label>
                                            <div class="col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                {!! Form::time('timme_start', null, array('placeholder' => 'Heure debut de la vsite','class' => 'form-control')) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                {!! Form::time('timme_end', null, array('placeholder' => 'Heure fin de la visite','class' => 'form-control')) !!}
                                            </div>
                                        </div>
